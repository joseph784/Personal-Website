...
export default function HomePage(){
    ...
    return (
        ...
        <div style={{backgroundImage: `url('background.png')`, backgroundRepeat:'no-repeat',  backgroundSize: 'cover'}}>      
            <div> 
                <h1 id="About Me"style={{fontFamily:'Franklin Gothic Medium', fontSize: 70, color: 'black', paddingTop: 30}}>
        ...
        <div style={{backgroundImage: `url('work.png')`, backgroundRepeat:'no-repeat',  backgroundSize: 'cover'}}>   
            <div id="Experience"> 
            ...
            <div>
                <div id="Projects"> 
                    ...
                    <h1 style={{fontFamily:'Franklin Gothic Medium', fontSize: 70, color: 'black', paddingTop: 35}}>
                        <Button onClick={() => handleClick('Experience')} className='buttonClass' variant="dark">↑</Button>{' '}
                        Projects
                    </h1> 
                </div> 
